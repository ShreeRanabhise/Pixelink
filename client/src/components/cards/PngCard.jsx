...
const PngCard = ({ png, onDownloadSuccess, rank }) => {
  ...
  if (rank === 1) {
    rankStyles = "ring-2 ring-yellow-400 z-10 scale-[1.02] shadow-[0_0_25px_rgba(250,204,21,0.35)] dark:shadow-[0_0_25px_rgba(250,204,21,0.6)] hover:shadow-[0_0_35px_rgba(250,204,21,0.5)] dark:hover:shadow-[0_0_35px_rgba(250,204,21,0.8)]";

...
const PngCard = ({ png, onDownloadSuccess, rank }) => {
  ...
  if (rank === 1) {
    rankStyles = "ring-2 ring-yellow-400 z-10 scale-[1.02] shadow-xl shadow-yellow-400/40 hover:shadow-2xl hover:shadow-yellow-400/50";
    rankIconColor = "text-yellow-400 bg-yellow-400/20 border-yellow-400/50";
  } else if (rank === 2) {
    rankStyles = "ring-2 ring-slate-300 z-10 scale-[1.01] shadow-xl shadow-slate-300/40 hover:shadow-2xl hover:shadow-slate-300/50";
    rankIconColor = "text-slate-200 bg-slate-300/20 border-slate-300/50";
  } else if (rank === 3) {
    rankStyles = "ring-2 ring-amber-600 z-10 scale-[1.01] shadow-xl shadow-amber-600/40 hover:shadow-2xl hover:shadow-amber-600/50";

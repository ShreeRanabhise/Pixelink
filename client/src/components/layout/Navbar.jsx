        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div ref={suggestionRef} className="hidden lg:flex flex-1 max-w-md mx-6 relative">
            <form onSubmit={handleSearch} className="w-full relative">
              ...
              <button
                type="submit"
                className="absolute right-1 top-1 bottom-1 px-4 bg-gradient-to-r from-rose-500 via-fuchsia-500 to-orange-500 animate-text-gradient hover:opacity-90 text-white text-xs font-semibold rounded-full transition-all flex items-center shadow-sm"
              >
                Search
              </button>
            </form>

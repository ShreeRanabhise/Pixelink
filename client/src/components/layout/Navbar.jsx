        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0 flex items-center">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="inline-block text-xl sm:text-2xl font-extrabold tracking-tight bg-gradient-to-r from-orange-500 via-violet-500 to-rose-500 animate-text-gradient bg-clip-text text-transparent">
                {settings.siteName}
              </span>
            </Link>
          </div>
          ...
          <div ref={suggestionRef} className="hidden lg:flex flex-1 max-w-md mx-6 relative">
            <form onSubmit={handleSearch} className="w-full relative">
              <input
                ...
                className="w-full pl-10 pr-24 py-2 rounded-full border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50 text-sm focus:outline-none focus:border-rose-500 focus:ring-2 focus:ring-rose-500/50 text-slate-800 dark:text-slate-200 transition-all"
              />

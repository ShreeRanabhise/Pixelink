...
const AdminSettings = () => {
  ...
  const systemStatus = [
    ...
    },
    {
      ...
      type: "AI Background Cutout",
      icon: Cpu,
      details:
        "Bypassing active image cutout calls. Saving original transparent uploads directly.",
  ...
  return (
    <AdminLayout title="System Configurations">
      {" "}
      <SEO title="System Settings" /> {/* Header controls */}{" "}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="glass p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-850 bg-white/80 dark:bg-slate-900/10 space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-600 dark:text-slate-500 mt-1">
                Status of internal databases, cloud storage assets, and
        ...
        {/* Administration Info (Right Column) */}{" "}
        <div className="space-y-6">
          ...
          <div className="glass p-6 rounded-3xl border border-slate-200 dark:border-slate-850 bg-white/80 dark:bg-slate-900/20 space-y-4">
            ...
            <h2 className="text-base font-bold text-white flex items-center">
              {" "}
              <ShieldAlert className="w-5 h-5 mr-2 text-brand-500" /> Active
              Admin Session{" "}
            </h2>{" "}
          ...
          <div className="glass p-6 rounded-3xl border border-slate-200 dark:border-slate-850 bg-white/80 dark:bg-slate-900/20 space-y-4">
            ...
            <h2 className="text-base font-bold text-white flex items-center">
              {" "}
              <Terminal className="w-5 h-5 mr-2 text-indigo-500" /> Local Upload
              Path{" "}
            </h2>{" "}
            ...
            <div className="bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-850 p-3 rounded-xl font-mono text-[10px] text-slate-350 break-all select-all">
              {" "}
              /server/uploads/{" "}
            </div>{" "}
            <div className="p-3 bg-indigo-500/10 border border-indigo-500/20 rounded-xl flex items-start space-x-2 text-[10px] text-indigo-400">
              ...
              <span>
                Ensure write permission is active on server directories for
                clean execution.
              </span>{" "}
            </div>{" "}
          </div>{" "}

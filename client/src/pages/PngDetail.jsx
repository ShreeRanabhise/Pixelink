          ...
          <div className="grid lg:hidden grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            ...
            <div className="space-y-3">
              <button
                ...
                className={`w-full h-full inline-flex items-center justify-center px-6 py-4 text-lg font-extrabold text-white bg-gradient-to-r from-orange-500 via-violet-500 to-rose-500 animate-hero-search-btn hover:opacity-90 rounded-2xl shadow-xl shadow-orange-500/20 transition-all ${
        ...
        <div className="lg:col-span-4 flex flex-col space-y-8 glass p-6 sm:p-8 rounded-[2.5rem] bg-white/60 dark:bg-slate-900/40 backdrop-blur-xl border border-slate-200/60 dark:border-slate-800/60 shadow-sm h-fit">
          ...
          <div className="space-y-3 hidden lg:block">
            <button
              onClick={handleDownload}
              disabled={isDownloading}
              className={`w-full inline-flex items-center justify-center px-6 py-4 text-lg font-extrabold text-white bg-gradient-to-r from-orange-500 via-violet-500 to-rose-500 animate-hero-search-btn hover:opacity-90 rounded-2xl shadow-xl shadow-orange-500/20 transition-all ${
                isDownloading ? 'opacity-70 cursor-not-allowed' : 'active:scale-95 hover:scale-[1.02]'
              }`}
            >
              <Download className={`w-5 h-5 mr-2 ${isDownloading ? 'animate-bounce' : ''}`} />
